!(function (a) {
  ...
  (a(".dropdown-menu a.dropdown-toggle").on("click", function (n) {
    return (
      ...
      a(this)
        ...
        .on("hidden.bs.dropdown", function (n) {
          a(".dropdown-submenu .show").removeClass("show");
        }),
      !1
    );
  }),
    a(".search-box-outer").length &&
      (a(".search-box-outer").on("click", function () {
        a("body").addClass("search-active");
      }),
      a(".close-search").on("click", function () {
        a("body").removeClass("search-active");
      })),
    a(document).on("ready", function () {
      a("[data-background]").each(function () {
        a(this).css(
          "background-image",
          "url(" + a(this).attr("data-background") + ")",
        );
      });
    }),
    a(".sidebar-btn").on("click", function () {
      (a(".sidebar-popup").addClass("open"),
        a(".sidebar-wrapper").addClass("open"));
    }),
    a(".close-sidebar-popup, .sidebar-popup").on("click", function () {
      (a(".sidebar-popup").removeClass("open"),
        a(".sidebar-wrapper").removeClass("open"));
    }),
    a.fn.owlCarousel &&
      a(".hero-slider").length &&
    ...
    a(window).on("load", function () {
      a(".filter-box").children().length > 0 &&
        ...
        a(".filter-btn").on("click", "li", function () {
          var n = a(this).attr("data-filter");
          a(".filter-box").isotope({ filter: n });
        }),
        a(".filter-btn li").each(function () {
          a(this).on("click", function () {
            (a(this).siblings("li.active").removeClass("active"),
    ...
    a("#scroll-top").on("click", function () {
      return (a("html, body").animate({ scrollTop: 0 }, 1500), !1);
    }),
    a(window).scroll(function () {
      a(this).scrollTop() > 50
        ? a(".navbar").addClass("fixed-top")
        : a(".navbar").removeClass("fixed-top");
    }),
    a(document).ready(function () {
      (a(".nav-item.dropdown .nav-link").on("click", function (n) {
        n.preventDefault();
        let o = a(this).next(".mega-menu");
        o.length && o.toggleClass("show");
      }),
        a(".mega-menu a").on("click", function (n) {
          let o = a(this).attr("href");
          o && "#" !== o && (window.location.href = o);
        }),
        a(document).on("click", function (n) {
          a(n.target).closest(".nav-item.dropdown").length ||
            a(".mega-menu").removeClass("show");
        }));
    }),
    a(document).ready(function () {
      a(".dispaly_desktop").click(function () {
        location.reload(!0);
      });
    }),
    a("[data-countdown]").each(function () {
      let n = a(this).data("countdown");
      a(this).countdown(n, function (n) {
        a(this).html(
          n.strftime(
  ...
  (a("#date").html(o),
    ...
    a(".main_mesnus_colors").click(function (a) {
    ...
    (function () {
      ...
      function scrollToElementId(id, behavior) {
      ...
      a(document).on("click", 'a[href*="#"]', function (e) {
        var href = a(this).attr("href");
        var id = samePageHashId(href);

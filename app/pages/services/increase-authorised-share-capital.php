...
<head>
    ...
    <style>
        ...
        .page-llp-registration .plc-docs-single-card-wrap { max-width: 920px; margin: 0; }
      ...
      "@graph": [
        {
          ...
          "serviceType": "Share Capital Increase and ROC Filing Services"
        },
        {
          "@type": "FAQPage",
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "What is the difference between authorised capital and paid-up capital?", "acceptedAnswer": { "@type": "Answer", "text": "Authorised capital is the maximum share capital a company can issue, while paid-up capital is the amount actually received from shareholders. Authorised capital must be increased before issuing shares beyond the existing limit." } },
            { "@type": "Question", "name": "Can we increase authorised capital and issue shares in the same EGM?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, both resolutions can be passed in the same meeting, but allotment can only be completed after SH-7 is filed and authorised capital is updated with ROC." } },
            { "@type": "Question", "name": "Does increasing authorised capital attract any tax or GST?", "acceptedAnswer": { "@type": "Answer", "text": "Increasing authorised capital does not attract income tax or GST, but stamp duty and ROC filing fees apply based on incremental capital." } }
          ]
        },
        {
          "@type": "BreadcrumbList",
...
<main class="main">
    <?php
    $caaft_hero_id = 'increase-capital-h1';
    $caaft_hero_h1 = 'Increase Authorised Capital - MOA Amendment & ROC Filing Services';
    $caaft_hero_h2_before = 'Scale Your Business Without Barriers - ';
    ...
    $caaft_overview_image_src = 'https://images.unsplash.com/photo-1554224152-824d793ca381?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80';
...
', 'icon_class' => 'fas fa-sack-dollar', 'tone' => 'blue'],
    ...
    <section class="plc-docs-section" aria-labelledby="authorized-capital-docs-heading">
        <div class="container">
            <h2 id="authorized-capital-docs-heading" class="plc-docs-title">Documents Required to Increase Authorised Capital</h2>
            <div class="plc-docs-cards-grid plc-docs-single-card-wrap">
    ...
    <?php
    $caaft_steps_heading_id = 'authorized-capital-steps-heading';
    ...
    <?php
    $caaft_benefits_heading_id = 'authorized-capital-consequences-heading';
    ...
    <?php
    $caaft_faq_heading_id = 'authorized-capital-faq-heading';

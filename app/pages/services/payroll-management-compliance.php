...
<head>
    ...
    <style>
        ...
        .page-llp-registration .payroll-docs-title { margin: 0 0 20px; font-size: clamp(1.5rem, 2.2vw, 2rem); line-height: 1.25; color: #1f2c40; font-weight: 700; }
        .page-llp-registration .payroll-docs-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 16px; }
        .page-llp-registration .payroll-doc-card { border: 1px solid #e2e8f0; border-radius: 12px; background: #ffffff; padding: 16px 16px 14px; box-shadow: 0 1px 2px rgba(15, 23, 42, 0.04); }
        .page-llp-registration .payroll-doc-card-head { display: flex; align-items: center; gap: 10px; margin-bottom: 12px; padding-bottom: 10px; border-bottom: 1px solid #edf2f7; }
        .page-llp-registration .payroll-doc-icon { width: 30px; height: 30px; border-radius: 8px; display: inline-flex; align-items: center; justify-content: center; color: #ffffff; font-size: 0.9rem; flex-shrink: 0; }
        .page-llp-registration .payroll-doc-icon.purple { background: #7c3aed; }
        .page-llp-registration .payroll-doc-icon.green { background: #10b981; }
        .page-llp-registration .payroll-doc-icon.orange { background: #f59e0b; }
        .page-llp-registration .payroll-doc-icon.blue { background: #3b82f6; }
        .page-llp-registration .payroll-doc-card h3 { margin: 0; font-size: 1.03rem; line-height: 1.3; color: #1f2c40; font-weight: 700; }
        .page-llp-registration .payroll-doc-list { margin: 0; padding: 0; list-style: none; }
        .page-llp-registration .payroll-doc-list li { position: relative; padding: 5px 0 5px 14px; font-size: 0.96rem; line-height: 1.5; color: #4a5568; }
        .page-llp-registration .payroll-doc-list li::before { content: ""; position: absolute; left: 0; top: 0.9em; width: 6px; height: 6px; border-radius: 50%; background: #33b6ff; }
        @media (max-width: 767.98px) {
            .page-llp-registration .payroll-docs-grid { grid-template-columns: 1fr; }
        }
    </style>
      ...
      "@graph": [
        {
          ...
          "description": "CAAFT provides accounting, taxation, payroll management, compliance, and CFO services across India.",
          ...
          "sameAs": [
            "https://www.linkedin.com/company/caaft",
            "https://www.facebook.com/caaft",
            "https://twitter.com/caaft"
          ],
          "knowsAbout": [
            "Payroll Management",
            "Payroll Compliance",
        ...
        },
        {
          ...
          "url": "https://caaft.com/payroll-management-compliance",
          "description": "End-to-end payroll management services in India including payroll processing, statutory compliance (PF, ESI, TDS), payroll system automation, salary structuring, and reporting.",
          "serviceType": "Payroll Management and Compliance Services",
          "provider": { "@id": "https://caaft.com/#organization" },
          "areaServed": { "@type": "Country", "name": "India" },
          "mainEntityOfPage": "https://caaft.com/payroll-management-compliance",
          "keywords": ["payroll management", "payroll compliance", "payroll processing", "payroll system", "payroll services India"],
          "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Payroll Services",
            "itemListElement": [
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Payroll Processing Services" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Payroll Compliance Management" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Payroll System Setup" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Salary Structuring & CTC Design" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Full & Final Settlement Processing" } }
            ]
          }
        },
        {
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "What is included in payroll processing services?", "acceptedAnswer": { "@type": "Answer", "text": "Payroll processing includes salary calculation, attendance integration, tax deductions, payslip generation, and salary disbursement." } },
            { "@type": "Question", "name": "What is a payroll system?", "acceptedAnswer": { "@type": "Answer", "text": "A payroll system is a structured software or process that automates salary calculation, tax deductions, and compliance reporting for employees." } },
            { "@type": "Question", "name": "Why is payroll outsourcing beneficial?", "acceptedAnswer": { "@type": "Answer", "text": "Payroll outsourcing reduces compliance risk, improves accuracy, saves costs, and ensures timely statutory filings managed by experts." } }
          ]
        },
        {
          "@type": "BreadcrumbList",
...
<main class="main">
    <?php
    $caaft_hero_id = 'payroll-h1';
    $caaft_hero_h1 = 'Payroll Management Services in India';
    $caaft_hero_h2_before = 'Accurate Payroll. Zero Compliance Gaps. ';
...
'CAAFT delivers end-to-end payroll management services for startups, SMEs, large enterprises, and MNCs operating in India. From accurate salary processing to statutory compliance — every layer of complexity is handled so internal teams can focus on what matters most.',
    ...
    $caaft_trust_items = [
        ...
        ['icon_class' => 'fas fa-user-tie', 'title' => 'CA-Led Payroll Processing', 'description' => 'Expert-Led Monthly Operations'],
        ['icon_class' => 'fas fa-balance-scale', 'title' => 'PF, ESI, TDS & PT Compliant', 'description' => 'Statutory Accuracy by Design'],
        ['icon_class' => 'fas fa-globe', 'title' => 'Pan-India Service', 'description' => 'Multi-State Compliance Coverage'],
    ];
    ...
    $caaft_overview_image_src = 'https://images.pexels.com/photos/3184374/pexels-photo-3184374.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800';
...
<div style="padding:0 0 40px;">
   ...
   <section class="payroll-compliance-section" aria-labelledby="payroll-compliance-req-heading">
    ...
    <section class="payroll-docs-section" aria-labelledby="payroll-documents-heading">
        <div class="container">
            <h2 id="payroll-documents-heading" class="payroll-docs-title">Documents Required for Payroll Processing</h2>
            <div class="payroll-docs-grid">
                <article class="payroll-doc-card">
                    <div class="payroll-doc-card-head">
    ...
    <?php
    $caaft_benefits_heading_id = 'payroll-outsourcing-benefits-heading';
...
'],
    ...
    <?php
    $caaft_faq_heading_id = 'payroll-faq-heading';

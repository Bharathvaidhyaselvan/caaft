...
<head>
    ...
    <style>
        ...
        .page-private-limited-registration .plc-docs-card-list li::before {
            content: "";
            position: absolute;
            left: 0;
            top: 0.92em;
    ...
    <main class="main">
        ...
        $caaft_trust_items = [
            ['icon_class' => 'fas fa-star', 'title' => 'Rated 4.8/5 ⭐', 'description' => 'on Google'],
                        ['icon_class' => 'fas fa-building', 'title' => 'Trusted Registration Partner', 'description' => 'Dedicated Expert Assistance'],
        ...
        $caaft_overview_image_src = '/assets/img/services-images/Business%20Set%20up%20%26%20REgistration/Pvt%20ltd.jpg';

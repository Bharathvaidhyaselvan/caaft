      ...
      "@graph": [
        {
          ...
          "description": "CAAFT provides feasibility study, business advisory, financial analysis, payroll, taxation, and compliance services across India.",
        ...
        },
        {
          ...
          "url": "https://caaft.com/feasibility-study",
          "description": "Professional feasibility study services including business feasibility analysis, financial modeling, market research, risk assessment, and investor-ready reports for startups and businesses in India.",
          "serviceType": "Business Feasibility Study and Financial Analysis",
          "provider": { "@id": "https://caaft.com/#organization" },
          "areaServed": { "@type": "Country", "name": "India" },
          "mainEntityOfPage": "https://caaft.com/feasibility-study",
          "keywords": ["feasibility study", "business feasibility study", "feasibility analysis", "financial feasibility analysis", "feasibility study services"],
          "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Feasibility Study Services",
            "itemListElement": [
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Business Feasibility Study" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Financial Feasibility Analysis" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Market Feasibility Study" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Technical Feasibility Assessment" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Project Report for Bank Loan" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Investor-Ready Business Analysis" } }
            ]
          }
        },
        {
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "Why is a feasibility study important for startups?", "acceptedAnswer": { "@type": "Answer", "text": "It helps startups validate demand, estimate costs, reduce risk, and make data-driven decisions before investing capital or launching operations." } },
            { "@type": "Question", "name": "Is a feasibility study required for a bank loan in India?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, most banks and NBFCs require a feasibility study or project report for business loans, especially for MSMEs and large loan amounts." } },
            { "@type": "Question", "name": "What is the difference between a feasibility study and a business plan?", "acceptedAnswer": { "@type": "Answer", "text": "A feasibility study evaluates whether a business idea is viable, while a business plan explains how the business will operate and grow after feasibility is confirmed." } }
          ]
        },
        {
          "@type": "BreadcrumbList",
...
<main class="main">
    <?php
    $caaft_hero_id = 'feasibility-study-h1';
    $caaft_hero_h1 = 'Feasibility Study Services';
    $caaft_hero_h2_before = 'Before committing a single rupee, know exactly whether a business idea ';
    ...
    $caaft_overview_image_src = '/assets/img/services-images/Advisory%20%26%20CFO/Feasibility%20Study.jpeg';
...
'],
    ...
    <?php
    $caaft_benefits_heading_id = 'feasibility-timeline-heading';
    $caaft_benefits_title = 'Timeline for Completing a Feasibility Study';
    ...
    <?php
    $caaft_benefits_heading_id = 'feasibility-benefits-heading';
    ...
    <?php
    $caaft_faq_heading_id = 'feasibility-faq-heading';

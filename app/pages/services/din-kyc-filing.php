      ...
      "@graph": [
        ...
        },
        {
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "Do foreign directors need to complete DIN KYC?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Foreign nationals holding a DIN must complete the Director KYC process annually by submitting valid identity proof such as a passport and overseas address proof, which may require notarisation or apostille." } },
            { "@type": "Question", "name": "What should a director do if their email or mobile number changes after filing KYC?", "acceptedAnswer": { "@type": "Answer", "text": "Updated details should be submitted during the next DIR-3 KYC filing cycle or through the appropriate MCA procedure to ensure accurate contact information is maintained in government records." } },
            { "@type": "Question", "name": "Can multiple directors from the same company complete KYC together?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Multiple directors from the same company can complete their KYC filings simultaneously. However, each director must submit an individual DIR-3 KYC form." } }
          ]
        },
        {
          "@type": "BreadcrumbList",
...
<main class="main">
    <?php
    $caaft_hero_id = 'din-kyc-h1';
    $caaft_hero_h1 = 'Director KYC (DIN KYC) — DIR-3 KYC Filing & DIN Reactivation Services';
    $caaft_hero_h2_before = 'Keep Your DIN Active. File on Time. ';
    $caaft_hero_h2_highlight = 'Stay Compliant — Every Year Without Disruption';
    $caaft_hero_h2_after = '';
    ...
    $caaft_trust_items = [
        ...
        ['icon_class' => 'fas fa-user-check', 'title' => '500+ Directors Served', 'description' => 'Across India'],
    ...
    <?php
    $caaft_overview_heading_id = 'din-kyc-what-heading';
    $caaft_overview_title = 'What is Director KYC (DIN KYC)?';
    ...
    $caaft_overview_image_src = 'https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800';
    $caaft_overview_image_alt = 'Director KYC and DIN reactivation services';
    ...
    <?php
    $caaft_benefits_heading_id = 'din-types-heading';
...
'Foreign nationals holding a DIN for their role in Indian companies',
    ...
    <section class="plc-docs-section" aria-labelledby="din-docs-heading">
        <div class="container">
            <h2 id="din-docs-heading" class="plc-docs-title">Documents Required for Director KYC Filing</h2>
    ...
    <?php
    $caaft_steps_heading_id = 'din-steps-heading';
    ...
    <?php
    $caaft_benefits_heading_id = 'din-consequences-heading';
    ...
    <?php
    $caaft_faq_heading_id = 'din-faq-heading';
    $caaft_faq_title = 'Frequently Asked Questions';
    $caaft_faq_accordion_id = 'accordionDinKycFaq';

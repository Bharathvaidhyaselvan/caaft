...
<head>
    ...
    <style>
        ...
        .gst-return-importance-item p {
            margin: 0;
            color: #4a4a4a;
            line-height: 1.55;
        }

        .gst-return-types-wrap {
            padding-top: 38px;
            padding-bottom: 44px;
        }

        .gst-return-types-title {
            margin: 0 0 8px;
            color: #2f2f2f;
            font-size: clamp(1.35rem, 2vw, 2rem);
            line-height: 1.2;
        ...
        .gst-return-types-table {
            border-top: 1px solid #d9dfe7;
        }

        .gst-return-types-head,
        .gst-return-types-row {
            display: grid;
            grid-template-columns: 0.9fr 1.5fr 1fr 1.6fr;
            gap: 14px;
            align-items: start;
            padding: 10px 4px;
        ...
        .gst-return-types-row > div {
            color: #3f4754;
            line-height: 1.5;
            font-weight: 600;
        }

        .gst-return-type-badge {
            display: inline-flex;
            align-items: center;
            padding: 3px 10px;
            border-radius: 999px;
        ...
        .gst-return-penalty-wrap {
            padding-top: 38px;
            padding-bottom: 44px;
        }

        .gst-return-penalty-title {
            margin: 0 0 8px;
            color: #2f2f2f;
            font-size: clamp(1.35rem, 2vw, 2rem);
            line-height: 1.2;
        ...
        .gst-return-penalty-list {
            border-top: 1px solid #d9dfe7;
        }

        .gst-return-penalty-item {
            display: grid;
            grid-template-columns: minmax(0, 1fr) auto;
            gap: 14px;
            align-items: center;
        ...
        .gst-return-penalty-pill--red {
            background: #fdeaea;
            color: #b14a4a;
        }

        .gst-return-penalty-pill--blue {
            background: #e7f1fe;
            color: #2f73bb;
        }

        .gst-return-penalty-pill--amber {
            background: #fef2df;
            color: #8b6123;
        }
...
?></div></div></div></div>
        ...
        $caaft_overview_image_src = 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80';
        ...
        <section class="gst-return-types-wrap"><div class="container"><h2 class="gst-return-types-title">Types of GST Returns</h2><p class="gst-return-types-intro">CAAFT manages the complete spectrum of GST return filings — not just the common ones.</p><div class="gst-return-types-table">
            ...
            <div class="gst-return-types-row"><div><span class="gst-return-type-badge">CMP-08</span></div><div>Composition taxpayers</div><div>Quarterly</div><div>Self-assessed tax payment statement</div></div>
        </div></div></section>

        <section class="gst-return-due-wrap"><div class="container"><h2 class="gst-return-due-title">GST Return Filing Due Dates</h2><p class="gst-return-due-intro">Missing these dates means late fees from the very next day. Key filing deadlines every GST-registered business must track:</p><div class="gst-return-due-list">
            <article class="gst-return-due-item"><div class="gst-return-due-main"><h3>GSTR-1 (Monthly filers — turnover above ₹5 crore)</h3><p>Outward supply return</p></div><span class="gst-return-due-pill">11th of the following month</span></article>
            <article class="gst-return-due-item"><div class="gst-return-due-main"><h3>GSTR-1 (QRMP scheme filers)</h3><p>Quarterly return cycle</p></div><span class="gst-return-due-pill">13th of the month after the quarter</span></article>
            <article class="gst-return-due-item"><div class="gst-return-due-main"><h3>GSTR-3B (Monthly filers)</h3><p>Regular taxpayers</p></div><span class="gst-return-due-pill">20th of the following month</span></article>
            <article class="gst-return-due-item"><div class="gst-return-due-main"><h3>GSTR-3B (QRMP filers — Class A states)</h3><p>Quarterly summary return</p></div><span class="gst-return-due-pill">22nd of the month after the quarter</span></article>
            <article class="gst-return-due-item"><div class="gst-return-due-main"><h3>GSTR-9 (Annual return)</h3><p>Previous financial year closure</p></div><span class="gst-return-due-pill">31st December for the previous financial year</span></article>
            <article class="gst-return-due-item"><div class="gst-return-due-main"><h3>CMP-08 (Composition dealers)</h3><p>Quarterly statement</p></div><span class="gst-return-due-pill">18th of the month after the quarter</span></article>
        </div><p class="gst-return-due-note">Due dates are subject to change by CBIC notifications. All official updates are actively monitored to ensure no deadline is missed.</p></div></section>

        <section class="gst-return-penalty-wrap"><div class="container"><h2 class="gst-return-penalty-title">Penalties for Late GST Return Filing</h2><p class="gst-return-penalty-intro">Late filing is one of the most common and entirely avoidable compliance costs for businesses. Key penalties under the GST Act:</p><div class="gst-return-penalty-list">
            <article class="gst-return-penalty-item"><div class="gst-return-penalty-main"><h3>Late fee — GSTR-1 and GSTR-3B (regular returns)</h3><p>₹25 CGST + ₹25 SGST per day</p></div><span class="gst-return-penalty-pill gst-return-penalty-pill--red">₹50 / day</span></article>
            <article class="gst-return-penalty-item"><div class="gst-return-penalty-main"><h3>Late fee — nil returns</h3><p>₹10 CGST + ₹10 SGST per day</p></div><span class="gst-return-penalty-pill gst-return-penalty-pill--red">₹20 / day</span></article>
            <article class="gst-return-penalty-item"><div class="gst-return-penalty-main"><h3>Maximum late fee cap per return</h3><p>₹5,000 each for CGST and SGST</p></div><span class="gst-return-penalty-pill gst-return-penalty-pill--blue">₹10,000 cap</span></article>

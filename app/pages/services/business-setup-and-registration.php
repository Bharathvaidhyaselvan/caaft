...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        ...
        {
          "@type": "Service",
          "@id": "https://caaft.com/business-setup-registration-services/#service-company-registration",
          "name": "Company Registration Services",
          "alternateName": "Business Incorporation Services Chennai",
          "url": "https://caaft.com/business-setup-registration-services/",
        ...
        {
          "@type": "Service",
          "@id": "https://caaft.com/business-setup-registration-services/#service-other-registrations",
          "name": "Other Business Registrations and Licences",
          "alternateName": "MSME FSSAI IEC DSC Registration Services Chennai",
          "url": "https://caaft.com/business-setup-registration-services/",
          "description": "CAAFT handles all essential licences and registrations — MSME/Udyam, FSSAI, Professional Tax, IEC, DSC, and 12A & 80G.",
          "provider": {"@id": "https://caaft.com/#organization"},
          "areaServed": {"@type": "Country", "name": "India"},
        ...
        {
          "@type": "FAQPage",
          "@id": "https://caaft.com/business-setup-registration-services/#faq",
          "mainEntity": [
            {
              "@type": "Question",
        ...
        {
          "@type": "BreadcrumbList",
          "@id": "https://caaft.com/business-setup-registration-services/#breadcrumb",
          "itemListElement": [
            {"@type": "ListItem", "position": 1, "name": "Home", "item": "https://caaft.com"},
            {"@type": "ListItem", "position": 2, "name": "Business Setup & Registration Services", "item": "https://caaft.com/business-setup-registration-services/"}
          ]
        }
      ]
    }
...
<body class="home-3 page-accounting-reporting page-bookkeeping-accounting page-business-setup-registration">
<?php include dirname(__DIR__, 2) . '/includes/gtm-noscript.php'; ?>
    ...
    <main class="main">
        ...
        $caaft_faq_heading_id = 'bsr-faq-heading';
        $caaft_faq_title = 'Frequently Asked Questions:';
        $caaft_faq_accordion_id = 'accordionBusinessSetupFaq';

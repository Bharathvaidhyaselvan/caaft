                ...
                <div class="main-menu  collapse navbar-collapse" id="main_nav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown  mega-menu-wrap dispaly_desktop ">
                            ...
                            <ul class="mega-menu row" style="padding: 14 !important;">
                                <li class="menu-has-sub col3">
                                    ...
                                    <div class="mega-split">
                                        <ul class="mega-split-col">
                                            ...
                                            <li><a href="/public-limited-company">Public Limited Company</a></li>
                                            <li><a href="/business-setup-registration/company-registration#parentVerticalTab3">One Person Company (OPC)</a></li>
                                ...
                                <li class="menu-has-sub col3">
                                    ...
                                    <div class="mega-split">
                                        <ul class="mega-split-col">
                                            ...
                                            <li><a href="/business-setup-registration/company-registration#parentVerticalTab5">Public Limited Compliance</a></li>
                                        </ul>
                                        <ul class="mega-split-col">

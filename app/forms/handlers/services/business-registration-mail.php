...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $secret = '6LcO3ukrAAAAAKpBylqkN7yp3JbXhmrwW8fKBJ13'; // Replace with your actual secret key
    ...
    $bcc = "kpwebtechseo@gmail.com"; // BCC recipient
    ...
    // 7. Email body
    $body = "
    <h2>Management Consulting Inquiry</h2>
